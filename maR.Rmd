...
daily_waste_rate = dt$allWasteKg / dailyInputKg

OONE_BOWL_SOUP_KG = 0.5
inputLiquidKg = OONE_BOWL_SOUP_KG * (df$regularOrders + df$miniOrders / 2)
...
mlm_all <- allWasteKg ~ tempC + humidityPerc + precipMM + sales + customer + liquors + week_day
