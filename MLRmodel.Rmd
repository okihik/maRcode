...
tsPlot <- ggplot() +
geom_line(data = dt, aes(x = date, y = allWasteKg), 
color="black") +
...
scatter_plot_waste_precip_sl <-
  ...
  geom_rug() +
  scale_y_continuous(name = "Daily Food Waste (kg)",
  limits = c(0, 5), expand = c(0.1, 0)) +
  scale_x_continuous(name = "Daily Precipitation (mm)",
  limits = c(0, 15), expand = c(0.1, 0)) +
  theme_pubr() +
...
corr <- round(cor(dt[c(11:12,16:18)]),2)
corr
