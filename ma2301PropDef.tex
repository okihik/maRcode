...
\begin{frame}{Today's Menu}
    ...
    \begin{minipage}[t]{0.35\textwidth} 
        \vspace{0pt}  
        \includegraphics[width=.9\textwidth]{ramen.jpg}
        \includegraphics[width=.9\textwidth]{ramen.jpg}
    \end{minipage}
\end{frame}
    ...
    \begin{block}{Collection Apparatus}
        % \begin{table}[]
            \begin{tabular}{cc}
                    ...
                    \includegraphics[width=1.8cm]{busket.jpg}
                    & 
                    \includegraphics[width=2cm]{busketStrainer.jpg}\\
                    \hline
                    Weight scale (0.05 - 150 kg) & Pen \& notebook\\ %\hline
                    \includegraphics[width=2cm]{scale.jpg}
                    & 
                    \includegraphics[width=2cm]{notebookPen.jpg}
            \end{tabular}
